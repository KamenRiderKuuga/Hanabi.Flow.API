...
using Hanabi.Flow.IService.Base;
...
namespace Hanabi.Flow.Services.Base
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        Task<PageModel<TEntity>> IBaseServices<TEntity>.QueryPage(Expression<Func<TEntity, bool>> whereExpression, int intPageIndex, int intPageSize, string strOrderByFileds)
        {
